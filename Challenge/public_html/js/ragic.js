...
//Authentication
(function () {
    var account = "alien_job"; //fill your account info
    var password = "thermit"; //fill your password info
...
*/
var url = "https://api.ragic.com/alien_job/petstore/1?v=3"; //your Pet Store Demo url
