...
ProgressBar.AnimationSmoothness={None:0,Smooth1:1,Smooth2:2,Smooth3:3,Smooth4:4};
ProgressBar.CreationType={Replace:0,AppendChild:1};
function ProgressBar(a,b){
    var i=0;
    var c=this;
    this.isLoaded=false;
    this.animation={opacity:1,opacityDirection:-1,isInitialized:false,markerPosition:0,markerDirection:1,timerId:null,smoothTimerId:null,smoothProgressSteps:[]};
    this.displayType=0;
    this.progress=0.0;
    ...
    this.value=0;
    this.initialValue=(b.value||0);
    this.minValue=(b.minValue||0);
    ...
    if(this.creationType==ProgressBar.CreationType.Replace){
        ...
        document.getElementById(a).appendChild(this.parentElement)}this.image=new Image();
    this.image.onload=function(){c.finishLoading()};
    this.image.src=this.imageUrl}ProgressBar.prototype.finishLoading=function(){if(!this.image.width||!this.image.width)return;
    var a="";
    ...
    for(i=0;i<b.length;i++){
        ...
        if(temp||typeof temp=="string")break}if(temp!=""&&ProgressBar._parseInt(temp)!=this.borderRadius)
    ...
    if((this.orientation==ProgressBar.Orientation.Horizontal&&this.image.width>=this.width)||(this.orientation==ProgressBar.Orientation.Vertical&&this.image.height>=this.height)){
        this.displayType=0}else{this.displayType=1}this.parentElement.className=(this.parentElement.className!=""?" ":"")+"progressbar_parent"+(this.extraClassName.parent?" ":"")+this.extraClassName.parent;
    if(this.displayType==0){
        ...
        this.borderWidth={left:ProgressBar._parseInt(ProgressBar._elementCurrentStyle(this.wrapperElement,"border-left-width")),
        ...
        if(this.orientation==ProgressBar.Orientation.Horizontal){
            this.borderWidth={left:ProgressBar._parseInt(ProgressBar._elementCurrentStyle(this.leftElement,"border-left-width")),
            ...
            this.borderWidth={left:ProgressBar._parseInt(ProgressBar._elementCurrentStyle(this.middleElement,"border-left-width")),
...
ProgressBar.prototype.setValue=function(a){
    if(a!==null&&a<this.minValue)a=this.minValue;
    if(a!==null&&a>this.maxValue)a=this.maxValue;
    if(a!==null&&this.animationSmoothness!=ProgressBar.AnimationSmoothness.None){
        if(this.animation.smoothTimerId!=null)
            clearInterval(this.animation.smoothTimerId);
        this.animation.smoothProgressSteps=[];
        var b=this.value;var i=a-this.value,j=0;
        while(Math.abs(i)>1){if(this.animationSmoothness==ProgressBar.AnimationSmoothness.Smooth1){j=i/2;
                ...
                j=i/4;if(Math.abs(j)>Math.abs(this.maxValue-this.minValue)*0.2)
                    j=(j>0?1:-1)*Math.abs(this.maxValue-this.minValue)*0.2
            }else{
                break
            }
            
            this.animation.smoothProgressSteps.push(b+j);
            b=b+j;
            i=a-b
        }
        
        this.animation.smoothProgressSteps.push(a);
    ...
    if(a===null){
        ...
        if(this.animation.smoothProgressSteps.length==0&&this.animation.smoothTimerId!=null)
            clearInterval(this.animation.smoothTimerId)
    }else{
        this.value=a
    }
    ...
    if(this.isLoaded){
        var d=0.0;
        if(this.orientation==ProgressBar.Orientation.Horizontal){
            d=(this.value/this.maxValue)*this.width;
            this.progressPosition=d;
            if(this.displayType==0){
                if(this.direction==ProgressBar.Direction.LeftToRight){
                    this.wrapperElement.style.backgroundPosition=(-this.image.width+d)+"px 0px"
                }else{
                    this.wrapperElement.style.backgroundPosition=(this.width-d)+"px 0px"
                }
            }else if(this.displayType==1){
                if(this.direction==ProgressBar.Direction.LeftToRight){
                    if(d<=this.borderRadius){
                        this.leftElement.style.backgroundPosition=(-this.image.width+d)+"px 0px";
                        this.rightElement.style.backgroundPosition=(-this.image.width)+"px 0px";
                        this.valueElement.style.width="0px"}else if(d>=this.width-this.borderRadius){
                        this.leftElement.style.backgroundPosition="0px 0px";
                        this.rightElement.style.backgroundPosition=(-this.image.width-(this.width-d-this.borderRadius))+"px 0px";
                        this.valueElement.style.width=this.middleElement.style.width
                    }else{
                        this.leftElement.style.backgroundPosition="0px 0px";
                        this.rightElement.style.backgroundPosition=(-this.image.width)+"px 0px";
                        this.valueElement.style.width=(d-this.borderRadius)+"px"
                    }
                }else{
                    if(d<=this.borderRadius){
                        this.leftElement.style.backgroundPosition=(this.image.width)+"px 0px";
                        this.rightElement.style.backgroundPosition=(this.image.width-d)+"px 0px";
                        this.valueElement.style.width="0px"
                    }else if(d>=this.width-this.borderRadius){
                        this.leftElement.style.backgroundPosition=(this.width-d)+"px 0px";
                        this.rightElement.style.backgroundPosition="0px 0px";
                        this.valueElement.style.left="0px";
                        this.valueElement.style.width=this.middleElement.style.width}else{this.leftElement.style.backgroundPosition=this.image.width+"px 0px";
                        this.rightElement.style.backgroundPosition="0px 0px";
                        this.valueElement.style.left=(this.width-d-this.borderRadius)+"px";
                        this.valueElement.style.width=(d-this.borderRadius)+"px"
                    }
                }
            }
            ...
            if(this.animationStyle!=ProgressBar.AnimationStyle.StaticFull&&this.animationStyle!=ProgressBar.AnimationStyle.CustomFull){
                if(this.direction==ProgressBar.Direction.LeftToRight){
                    ...
                    this.markerElement.style.left=(this.width-d+this.borderWidth.left)+"px"
                }
            }else{
                this.markerElement.style.left=this.borderWidth.left+"px"
            }
            
            var e=(-this.height*2-this.height-this.borderWidth.top);
            var f=(-this.height*2-this.borderWidth.top);
            if(d==0||this.width==d){
                this.textElement.style.top=e+"px";
                this.markerElement.style.top=f+"px";
                this.markerElement.style.height=this.height+"px";
                this.markerElement.style.cssText=this.markerElement.style.cssText+ProgressBar._createBorderRadiusCss(this.borderRadius)
            }else if(d<this.borderRadius){
                var g=this.height-2.25*(this.borderRadius-Math.sqrt(Math.pow(this.borderRadius,2)-Math.pow(this.borderRadius-d,2)));
                var h=f+(this.height/2)-(g/2);
                var k=e-2*(f-h);
                
                this.textElement.style.top=k+"px";
                this.markerElement.style.top=h+"px";
                this.markerElement.style.height=g+"px";
                if(this.direction==ProgressBar.Direction.LeftToRight){
            ...
            }else if(this.width-d<this.borderRadius){
                var l=((this.borderRadius-(this.width-d))*2+(this.borderRadius-Math.sqrt(Math.pow(this.borderRadius,2)-Math.pow(this.borderRadius-(this.width-d),2))))/3;
                if(this.direction==ProgressBar.Direction.LeftToRight){
                    this.markerElement.style.cssText=this.markerElement.style.cssText+ProgressBar._createBorderRadiusCss(this.borderRadius,l,l,this.borderRadius)
                }else{
                    this.markerElement.style.cssText=this.markerElement.style.cssText+ProgressBar._createBorderRadiusCss(l,this.borderRadius,this.borderRadius,l)
                }
            }else{
                this.textElement.style.top=e+"px";
                this.markerElement.style.top=f+"px";
            ...
            d=(this.value/this.maxValue)*this.height;
            this.progressPosition=d;
            if(this.displayType==0){
                if(this.direction==ProgressBar.Direction.TopToBottom){
                    this.wrapperElement.style.backgroundPosition="0px "+(d-this.image.height)+"px"
                }else{
                    this.wrapperElement.style.backgroundPosition="0px "+(this.height-d)+"px"
                }
            }else if(this.displayType==1){
                if(this.direction==ProgressBar.Direction.TopToBottom){
                    if(d<=this.borderRadius){
                        this.leftElement.style.backgroundPosition="0px "+(-this.image.height+d)+"px";
                        this.rightElement.style.backgroundPosition="0px "+(-this.image.height)+"px";
                        this.valueElement.style.height="0px"
                    }else if(d>=this.height-this.borderRadius){
                        this.leftElement.style.backgroundPosition="0px 0px";
                        this.rightElement.style.backgroundPosition="0px "+(-this.image.height-(this.height-d-this.borderRadius))+"px";
                        this.valueElement.style.height=this.middleElement.style.height}else{this.leftElement.style.backgroundPosition="0px 0px";
                        this.rightElement.style.backgroundPosition="0px "+(-this.image.height)+"px";
                        this.valueElement.style.height=(d-this.borderRadius)+"px"
                    }
                }else{
                    if(d<=this.borderRadius){
                        this.leftElement.style.backgroundPosition="0px "+(this.borderRadius)+"px";
                        this.rightElement.style.backgroundPosition="0px "+(this.borderRadius-d)+"px";
                        this.valueElement.style.height="0px"
                    }else if(d>=this.height-this.borderRadius){
                        this.leftElement.style.backgroundPosition="0px "+(this.height-d)+"px";
                        this.rightElement.style.backgroundPosition="0px 0px";
                        this.valueElement.style.top="0px";
                        this.valueElement.style.height=this.middleElement.style.height}else{this.leftElement.style.backgroundPosition="0px "+this.borderRadius+"px";
                        this.rightElement.style.backgroundPosition="0px 0px";
                        this.valueElement.style.top=(this.height-d-this.borderRadius)+"px";
                        this.valueElement.style.height=(d+this.borderRadius*2)+"px"
                    }
                }
            }
            ...
            if(d>0){
                if(this.animationStyle!=ProgressBar.AnimationStyle.StaticFull&&this.animationStyle!=ProgressBar.AnimationStyle.CustomFull){
                    this.markerElement.style.height=d+"px"
                }else{
                    this.markerElement.style.height=this.height+"px";
                    this.markerElement.style.cssText=this.markerElement.style.cssText+ProgressBar._createBorderRadiusCss(this.borderRadius)
                }
                ...
                if(this.animationStyle!=ProgressBar.AnimationStyle.None)
                    this.markerElement.style.visibility="visible"}else{this.markerElement.style.height=0+"px";
                    if(this.animationStyle!=ProgressBar.AnimationStyle.StaticFull&&this.animationStyle!=ProgressBar.AnimationStyle.CustomFull)
                        this.markerElement.style.visibility="hidden"}var m=this.borderWidth.left;
                    
                    var n=this.borderWidth.left;
                    if(d==0||this.height==d){
                        this.markerElement.style.left=n+"px";
                        this.markerElement.style.width=this.width+"px";
                        this.markerElement.style.cssText=this.markerElement.style.cssText+ProgressBar._createBorderRadiusCss(this.borderRadius)
                    }else if(d<this.borderRadius){
                        var o=2.5*d;
                        if(o>this.width)o=this.width;
                        var p=n+(this.width/2)-(o/2);
                        this.markerElement.style.left=p+"px";
                        this.markerElement.style.width=o+"px";
                    ...
                    }else if(this.height-d<this.borderRadius){
                        var l=((this.borderRadius-(this.height-d))*2+(this.borderRadius-Math.sqrt(Math.pow(this.borderRadius,2)-Math.pow(this.borderRadius-(this.height-d),2))))/3;
                        if(this.direction==ProgressBar.Direction.BottomToTop){
                            this.markerElement.style.cssText=this.markerElement.style.cssText+ProgressBar._createBorderRadiusCss(l,l,this.borderRadius,this.borderRadius)
                        }else{
                            this.markerElement.style.cssText=this.markerElement.style.cssText+ProgressBar._createBorderRadiusCss(this.borderRadius,this.borderRadius,l,l)
                        }
                    }else{
                        this.markerElement.style.left=n+"px";
                        this.markerElement.style.width=this.width+"px";
                    ...
                    if(this.animationStyle!=ProgressBar.AnimationStyle.StaticFull&&this.animationStyle!=ProgressBar.AnimationStyle.CustomFull){
                        this.textElement.style.top=-(this.height*2+d+this.borderWidth.top)+"px"
                    }else{
                    ...
                    if(this.animationStyle!=ProgressBar.AnimationStyle.StaticFull&&this.animationStyle!=ProgressBar.AnimationStyle.CustomFull){
                        if(this.direction==ProgressBar.Direction.TopToBottom){
                            ...
                            this.markerElement.style.top=(-this.height-d-this.borderWidth.top)+"px"
                        }
                    }else{
                        this.markerElement.style.top=(-this.height*2-this.borderWidth.top)+"px"
                    }
                ...
                if(this.showLabel){this.textElement.style.display="";
                    if(this.labelText!=""){var q=this.labelText;
                        if(q.indexOf("{value")!=-1){
                            var i=0;
                            while(q.indexOf("{value}")!=-1)
                                q=q.replace("{value}",this.value);
                            while(q.indexOf("{value,")!=-1){
                                var r=q;r=r.substr(r.indexOf("{value,")+7);
                                r=r.substr(0,r.indexOf("}"));
                                var s="";
                                if(parseInt(r)>0){
                                    s=String(Math.round(this.value*Math.pow(10,parseInt(r)))/Math.pow(10,parseInt(r)));
                                    if(s.indexOf(".")==-1)s+=".";
                                    var t=s.substr(s.indexOf(".")+1).length;
                                    if(t<parseInt(r))
                                        for(i=t;i<parseInt(r);i++)s+="0"
                                }else{
                                    s=Math.round(this.value)
                                }
                                
                                q=q.replace("{value,"+r+"}",s)
                            }
                        }
                        
                        while(q.indexOf("{progress}")!=-1)
                            q=q.replace("{progress}",Math.round((this.value/this.maxValue)*100));
                        this.textElement.innerHTML=q
                    }else{
        ...
        ProgressBar.prototype.setForeground=function(a){
            this.imageUrl=a;
            if(this.isLoaded){
        ...
        ProgressBar.prototype.setBackground=function(a){this.backgroundUrl=a;
            if(this.isLoaded){this.backgroundElement.style.backgroundImage="url('"+this.backgroundUrl+"')";
                this.setValue(this.value)}};
        
        ProgressBar.prototype.setMarkerImage=function(a){this.markerUrl=a;
            if(this.isLoaded){this.markerElement.style.backgroundImage="url('"+this.markerUrl+"')";
                this.setValue(this.value)}};
        
        ProgressBar.prototype.setAnimationStyle=function(a){
            this.animation.isInitialized=false;
            this.animationStyle=(a||ProgressBar.AnimationStyle.None);
            if(this.animationStyle==ProgressBar.AnimationStyle.None){
            ...
            if(this.animationStyle==ProgressBar.AnimationStyle.Flickering1||this.animationStyle==ProgressBar.AnimationStyle.Flickering2||this.animationStyle==ProgressBar.AnimationStyle.Flickering3){
                ...
                }else{this.animation.markerPosition=-this.image.height
                }
            ...
            if(this.animationStyle!=ProgressBar.AnimationStyle.None){
                var b=this;
                this.animation.timerId=setInterval(function(){b.blink()},this.animationInterval)
            }
        };
        
        ProgressBar.prototype.blink=function(){this.animation.isInitialized=true;
            if(this.onAnimate)this.onAnimate();
            if(this.animationStyle==ProgressBar.AnimationStyle.Flickering1||this.animationStyle==ProgressBar.AnimationStyle.Flickering2||this.animationStyle==ProgressBar.AnimationStyle.Flickering3){
                var a=null;
                if(this.animationStyle==ProgressBar.AnimationStyle.Flickering1)
                    a={step:0.05,growSpeed:3,decSpeed:1,maxOpacity:0.75,minOpacity:0.2};
                if(this.animationStyle==ProgressBar.AnimationStyle.Flickering2)
                    a={step:0.05,growSpeed:1,decSpeed:1,maxOpacity:0.75,minOpacity:0.2};
                if(this.animationStyle==ProgressBar.AnimationStyle.Flickering3)
                    a={step:0.05,growSpeed:1,decSpeed:3,maxOpacity:0.75,minOpacity:0.2};
                a.step=a.step*this.animationSpeed;
                if(this.animation.opacity<0)this.animation.opacity=0;
                if(this.animation.opacity>1)this.animation.opacity=1;
                this.animation.opacity+=a.step*this.animation.opacityDirection*(this.animation.opacityDirection>0?a.growSpeed:a.decSpeed);
                if(this.animation.opacity>=a.maxOpacity||this.animation.opacity<=a.minOpacity){
                    this.animation.opacityDirection=-this.animation.opacityDirection;
                    if(this.animation.opacity>a.maxOpacity)this.animation.opacity=a.maxOpacity;
                    if(this.animation.opacity<a.minOpacity)this.animation.opacity=a.minOpacity
                }
                ...
                if(this.orientation==ProgressBar.Orientation.Horizontal){
                    ...
                    if(this.animationStyle==ProgressBar.AnimationStyle.LeftToRight1||this.animationStyle==ProgressBar.AnimationStyle.LeftToRight2){
                        ...
                        if(this.animation.markerPosition>=this.progressPosition-this.borderRadius*2||this.animation.markerPosition<=-this.borderRadius*20)
                            this.animation.markerDirection=-this.animation.markerDirection}this.markerElement.style.backgroundPosition=(this.animation.markerPosition)+"px 0px"
                    }else{
                        if(this.animationStyle==ProgressBar.AnimationStyle.LeftToRight1||this.animationStyle==ProgressBar.AnimationStyle.LeftToRight2){
                            this.animation.markerPosition+=20*this.animationSpeed;
            ...
            ProgressBar._elementCurrentStyle=function(a,b){
                if(a.currentStyle){var i=0,temp="",changeCase=false;
                    for(i=0;i<b.length;i++){
                        if(b.charAt(i)&&(b.charAt(i)!='-'||b.charAt(i).toString()!='-')){
                            ...
                            }else{temp=temp+(changeCase?b.charAt(i).toUpperCase():b.charAt(i))
                            }changeCase=false
                        }else{
                            changeCase=true
                        }
            ...
            ProgressBar._parseInt=function(a){
                var b=parseInt(a);
                if(isNaN(b))
                    b=0;
                return b
            ...
            ProgressBar._createBorderRadiusCss=function(a,b,c,d){
                if(a!=null&&b==null&&c==null&&d==null){
                    return";\n\ -moz-border-radius: "+a+"px; -ms-border-radius: "+a+"px; -o-border-radius: "+a+"px; -webkit-border-radius: "+a+"px; -khtml-border-radius: "+a+"px; border-radius: "+a+"px;"
                }else{
                    a=(a||0);
                    b=(b||0);
                    c=(c||0)
                    ;d=(d||0);
                    return"; -moz-border-radius: "+a+"px "+b+"px "+c+"px "+d+"px; -ms-border-radius: "+a+"px "+b+"px "+c+"px "+d+"px; -o-border-radius: "+a+"px "+b+"px "+c+"px "+d+"px; -webkit-border-radius: "+a+"px "+b+"px "+c+"px "+d+"px; -khtml-border-radius: "+a+"px "+b+"px "+c+"px "+d+"px; border-radius: "+a+"px "+b+"px "+c+"px "+d+"px;"
                }
            };